    ...
    <div className="container-narrow py-10">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-semibold">JPG to PDF</h1>
          <p className="mt-2 text-slate-600 dark:text-slate-300">Convert JPG images to PDF. All processing happens locally.</p>
        </div>
        <div className="card p-6 md:p-8">
          <UploadZone accept=".jpg,.jpeg" multiple={true} onFiles={setFiles} />
